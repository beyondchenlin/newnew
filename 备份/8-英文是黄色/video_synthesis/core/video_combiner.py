...
Style: CN,微软雅黑,70,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,1,0,0,0,100,100,0,0,3,0,0,2,30,30,160,1
Style: EN,微软雅黑,50,&H00000000,&H000000FF,&H0000FFFF,&H0000FFFF,1,0,0,0,100,100,0,0,3,2,0,8,30,30,160,1
Style: CN_Hidden,微软雅黑,70,&HFFFFFFFF,&H000000FF,&HFF000000,&HFF000000,1,0,0,0,100,100,0,0,3,0,0,2,30,30,160,1
Style: EN_Hidden,微软雅黑,50,&HFF000000,&H000000FF,&HFF00FFFF,&HFF00FFFF,1,0,0,0,100,100,0,0,3,2,0,8,30,30,160,1
...
"""
    ...
    try:
        ...
        with open(merged_ass, 'w', encoding='utf-8') as f:
            ...
            logger.info("样式设置:")
            logger.info("CN: 白色文字(不透明) + 黄色背景(不透明)")
            logger.info("EN: 黄色文字(不透明) + 黑色背景")
            logger.info("CN_Hidden: 白色文字(透明) + 黄色背景(透明)")
